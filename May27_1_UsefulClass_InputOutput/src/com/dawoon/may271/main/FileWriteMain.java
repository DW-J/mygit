...
// CUP 		: 연산장치
// RAM		: 저장장치(임시) - 재부팅하면 날라감
//			static / stack - 프로그램을 끄면(종료하면) 날아감
//			heap - 자동으로 잘아감 X (Garbage Collector 있으면 자동으로 날아감)
// HDD(SSD) : 저장장치(영구) - 파일
...
// 'Stream' : '빨대'
// 		기본형
//			InputStream	: 장치 -> 프로그램으로 출력 (1byte씩) - 요구르트빨대
...
public class FileWriteMain {
	public static void main(String[] args) {
		...
		// 		프로그램 => 파일
		// 		파일이 없으면 만들어주기도 함
		//		폴도는 안만들어줌 (반드시 폴더가 존재해야함)
		//	Linux의 경로 : C:\\Users\\cloud\\OneDrive\\바탕 화면\\Test/dawoon1.txt
		//		=> /로 경로 설정
		//	Windows의 경로 : C:\\Users\\cloud\\OneDrive\\바탕 화면\\Test\\dawoon1.txt
		// 		=> \\로 경로 설정 + / 하나로도 가능!
		// 	Java의 \는 : \t, \r, \n, \0, ... (이스케이프 문자) 에 사용
		//	권한, 폴도명 오타, ... => 예외처리!
		...
		try {
			...
			// 기종의 내용 뒤에 덧붙이고 싶으면 (데이터를 추가하고 싶다면)
			// 두번째 파라미터의 값으로 true를 주면 됨
			
			// Encoding 방식지정 X => ANSI로 인코딩됨
			FileWriter fw = new FileWriter("C:\\Users\\cloud\\OneDrive\\바탕 화면\\Test/dawoon1.txt");
