...
create table jun05_ceo(
	c_no number(3) primary key,			-- 사장 번호
...
insert into jun05_menu values(jun05_menu_seq.nextval, '볶음밥', 5000, 1);
insert into jun05_menu values(jun05_menu_seq.nextval, '유산슬', 12000, 1);
insert into jun05_menu values(jun05_menu_seq.nextval, '멘보샤', 9000, 1);
--
insert into jun05_menu values(jun05_menu_seq.nextval, '짜장밥', 5500, 2);
insert into jun05_menu values(jun05_menu_seq.nextval, '짬뽕밥', 6000, 2);
insert into jun05_menu values(jun05_menu_seq.nextval, '차돌짬뽕', 8000, 2);
insert into jun05_menu values(jun05_menu_seq.nextval, '고추잡체', 7000, 2);
insert into jun05_menu values(jun05_menu_seq.nextval, '쟁반짜장', 8500, 2);
--
insert into jun05_menu values(jun05_menu_seq.nextval, '폭탄계란찜', 4000, 3);
insert into jun05_menu values(jun05_menu_seq.nextval, '마른안주모듬', 8000, 3);
insert into jun05_menu values(jun05_menu_seq.nextval, '후라이드 치킨', 12000, 3);
insert into jun05_menu values(jun05_menu_seq.nextval, '양념 치킨', 13000, 3);
insert into jun05_menu values(jun05_menu_seq.nextval, '먹태', 7000, 3);
--
insert into jun05_menu values(jun05_menu_seq.nextval, '김치우동', 7500, 4);
insert into jun05_menu values(jun05_menu_seq.nextval, '떡복이', 5000, 4);
insert into jun05_menu values(jun05_menu_seq.nextval, '소시지 모둠', 9000, 4);
insert into jun05_menu values(jun05_menu_seq.nextval, '불닭발', 10000, 4);
insert into jun05_menu values(jun05_menu_seq.nextval, '부대찌게', 11000, 4);
