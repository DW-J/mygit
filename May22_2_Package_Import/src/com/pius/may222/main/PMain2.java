...
import com.pius.may222.product.Computer; // 앞으로 잘 살펴보기
...
public class PMain2 {
	public static void main(String[] args) {
		...
		com.pius.may222.product.Scanner s =
				new com.pius.may222.product.Scanner("test", 1000);
		...
		// 같은 패키지 소속
		com.pius.may222.main.Pius p1 = new com.pius.may222.main.Pius();
		Pius p2 = new Pius();
		
		// 다른 패키지 소속
		com.pius.may222.product.Computer c = new Computer();
