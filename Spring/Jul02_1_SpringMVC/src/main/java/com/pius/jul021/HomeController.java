...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		//		- 실행시에 특저한 기능을 수행하도록 도와줌
		
		// 종류
		//	1. @Bean : 개발자가 직업 제어가 불가능한 오ㅟ부 라이브러리 등을
		//		Bean으로 만들 때 사용
		//	★2. @Autowired : 속성, setter, 생성자에서 사용하면,
		//		타입에 따라서 Bean을 주입해준다.
		...
		//			: 언마샬링 (Unmashalling)
		//		XmlRootElement : Javabean 객체의 Class명 위에 명 ㅣO
