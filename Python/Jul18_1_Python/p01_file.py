...
# w : 덮어쓰기
# file = open("C:/Users/cloud/Desktop/Test/data/test.txt", "w", encoding="UTF-8")
# file.write("오늘은 비가 겁나 오네요 ㅠ_ㅠ 이따 점심 회식인데...")
# print("완료!")
# file.close()

# 2. 파일에 내용을 추가 (append)
# file = open("C:/Users/cloud/Desktop/Test/data/test.txt", "a", encoding="UTF-8")
# file.write("\n오늘 제가 살아서 돌아온다면...\n그녀에게 고백하겠어요...\n흙흙...")
# print("완료!")
# file.close()

# 3. 파일 읽어오기 (read)
file = open("C:/Users/cloud/Desktop/Test/data/test.txt", "r", encoding="UTF-8")
