...
for i in range(1, 11):
    fileName = "C:/Users/cloud/Desktop/Test/data/ThreeKingdoms/ThreeKingdoms%02d.txt" % i
    # print(fileName)
...
with open("C:/Users/cloud/Desktop/Test/data/tkResult.csv", "w", encoding="UTF-8") as f:
    for k, v in wc.items():
        f.write(f"{k},{v}\n")
