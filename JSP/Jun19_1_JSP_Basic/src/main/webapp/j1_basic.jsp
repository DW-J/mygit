...
<body>
	...
	---------------------------- 어렵고, 작업이 불편 
	- 이러한 단점을 극복하기 위해 만든 것이 바로
	----------------------------
	JSP (Java Servlet/Server Page) [Model 1] <!-- 엄밀히 말하자면 [JSP Model 1] -->
		작업형태 : HTML + CSS + JavaScript에  필요한 부분마다 Java코드를 조금씩/살짝 첨가!	
