...
public class HomeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		MemberDAO.loginCheck(request); // 로그인 체크
		request.setAttribute("cp", "home.jsp"); // home.jsp에서 시작히서
		request.getRequestDispatcher("index.jsp").forward(request, response); // index.jsp로 포워딩
	}
