<%@page import="com.pius.db.manager.PiusDBManager"%>
...
<body>
	<%
		...
		// 기존 : DriverManager.getConnection()을 실행하는 순간에
		//	관련된 모든 작업을 해서 Connection 객체를 만들어 줌 => 비교적 느림
		
		// 커엑션풀 : 미리 Connection객체 x 100개 만들어놓고
		...
		PiusDBManager.close(con, null, null);
	%>
	<h1>DB연결</h1>
	<h1><%=result %></h1>
