...
public class YMain {
	public static void main(String[] args) {
		...
		//		내가 '홀'이라고 하면
		//		정답인지 안닌지 판정해서 그 결과를 출력해주는 프로그램
//		Random r = new Random();
//			int i = r.nextInt();		// int 범위안에 있는 랜덤한 정수
//			int i2 = r.nextInt(5);		// 0 ~ 4 중 랜덤한 정수
//			int i3 = r.nextInt(10) + 1;	// 1 ~ 10 중 랜덤한 정수
...
//		System.out.println(answer);
		...
		String draw = keyboard.next();
//		System.out.println(draw);
		
		// 결과를 맞춰봐야! (컴퓨터가 뽑은 정답과 대가 입력한 정답이 같은지)
		String result = (answer.equals(draw)) ? "정답" : "오답";
