...
// Call By Reference : 변수를 참조하는 주소값(번지값)을 파리미터로 전달하는 것 
...
//		c = { 100, 200 }; (비정규식) // 에러 !	(약식을 사용해도 새로운 수를 만들어내는 것이지
								// 			값을 변경하는 것은 아님)
	...
	public static void main(String[] args) {
		...
		System.out.println(b[0] + "b(red)");	// 100?
												// *** 값 변경에 영향을 받았음
		System.out.println(c[0] + "c(red)");	// 100? 10!
												// *** 값 변경에 영향을 받지 않음
...
// Java에서 파라미터를 넘기는 과정에 직접적인 참조를 넘기는게 아니라,
